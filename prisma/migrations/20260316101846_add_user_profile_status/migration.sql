-- CreateEnum
CREATE TYPE "UserProfileStatus" AS ENUM ('active', 'inactive', 'graduated');
...
-- AlterTable
ALTER TABLE "user_profiles" ADD COLUMN     "status" "UserProfileStatus" NOT NULL DEFAULT 'active',
ALTER COLUMN "id" SET DEFAULT generate_prefixed_uuid('UPF');
