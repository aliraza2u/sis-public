...
-- AlterTable
ALTER TABLE "courses" ADD COLUMN     "banner_meta" JSONB,
ADD COLUMN     "intro_video_meta" JSONB,
ADD COLUMN     "intro_video_source" VARCHAR(20),
ADD COLUMN     "thumbnail_meta" JSONB,
